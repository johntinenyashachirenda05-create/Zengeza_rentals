# Generated by Django 5.2.9 on 2026-01-03 18:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending Approval'), ('approved', 'Approved'), ('available', 'Available'), ('taken', 'Taken')], default='pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(choices=[('EcoCash', 'EcoCash'), ('InnBucks', 'InnBucks'), ('OneMoney', 'OneMoney')], max_length=20)),
